...
class EntertainmentNews_OptionsManager {
    ...
    public function getOptionMetaData() {
        return array('limit' => 'Article Limit');
    }
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'entertainment-news'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'entertainment-news'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'entertainment-news'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'entertainment-news'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'entertainment-news');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'entertainment-news'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'entertainment-news');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'entertainment-news'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'entertainment-news') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'entertainment-news');
            case 'false':
                return __('false', 'entertainment-news');

            case 'Administrator':
                return __('Administrator', 'entertainment-news');
            case 'Editor':
                return __('Editor', 'entertainment-news');
            case 'Author':
                return __('Author', 'entertainment-news');
            case 'Contributor':
                return __('Contributor', 'entertainment-news');
            case 'Subscriber':
                return __('Subscriber', 'entertainment-news');
            case 'Anyone':
                return __('Anyone', 'entertainment-news');
        }
        return $optionValue;
    }
